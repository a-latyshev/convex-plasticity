...
parser.add_argument("--patch-size-max", type=bool, default=True, action=argparse.BooleanOptionalAction, help="if True take max patch size")
parser.add_argument("--solver", type=str, default="CLARABEL", help="convex solver name (e.g. CLARABEL, MOSEK)")
parser.add_argument("--compiled", type=bool, default=False, action=argparse.BooleanOptionalAction, help="whether to use cvxpygen")
