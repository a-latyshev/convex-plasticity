...
\begin{appendices}
    ...
    \begin{align*}
        ...
        % & \uuuuD : \Delta\uueps = \frac{1}{\sqrt{1 + 2\alpha^2}}\left( \uuN : \Delta\uueps \left( \frac{9\alpha\mu k}{\gamma}\uuUnit + 3\mu\left(\frac{3\mu}{\gamma} - \beta\right)\uuN \right) + \mtr \Delta\uueps \left( \frac{9\alpha\mu k}{\gamma}  \uuN + \frac{9\alpha^2k^2}{\gamma} \uuUnit \right) + 2\mu\beta \Delta\uue^p \right) \\
        % & \uuuuD : \Delta\uueps = \\
        % & = \left( \uuN : \Delta\uueps 3\mu \left( \frac{3\mu}{\gamma} - \beta \right) \uuN + \frac{9\alpha\mu k}{\gamma} (\uuN : \Delta\uueps \uuUnit + \mtr\Delta\uueps \uuN) + \frac{9\alpha^2k^2}{\gamma} \mtr \Delta\uueps \uuUnit + 2\mu\beta \Delta\uue^p \right)  \\
    \end{align*}
