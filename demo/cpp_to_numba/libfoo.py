...
_lib.get_ns__ns2__BarCls__fun_address.argtypes = ()
_lib.get_ns__ns2__BarCls__fun_address.restype = ctypes.c_void_p
with _target_info:
    _ns__ns2__BarCls__fun_signature = rbc.typesystem.Type.fromstring("int ()")
ns__ns2__BarCls__fun = _ns__ns2__BarCls__fun_signature.toctypes()(_lib.get_ns__ns2__BarCls__fun_address())
__all__.append("ns__ns2__BarCls__fun")
