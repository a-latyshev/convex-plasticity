...
\begin{table}[H]
	...
	\begin{tabular}{|cccc|}
		...
		\hline
	\end{tabular}
	\caption{Mesh data for numerical tests}
    \label{tab:cvxpy_tests}
\end{table}
where Q2 space means the size of the finite element functional space of the second degree based on quadrature elements.s
