...
mpirun -n 8 python demo_plasticity_rankine.py --h 0.3 --solver CLARABEL --patch-size-max True --compiled True
mpirun -n 8 python demo_plasticity_rankine.py --h 0.06 --solver CLARABEL --patch-size-max True --compiled True
mpirun -n 8 python demo_plasticity_rankine.py --h 0.025 --solver CLARABEL --patch-size-max True --compiled True
mpirun -n 8 python demo_plasticity_rankine.py --h 0.01 --solver CLARABEL --patch-size-max True --compiled True
