...
#                     return_mapping.solve_and_derivate(verbose=False, eps=1e-13) #, alpha=1, scale=5.
...
#                     return_mapping_residue.solve_and_derivate(verbose=False, eps=1e-13) #, alpha=1, scale=5.
